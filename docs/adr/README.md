...
| [166](./166-active-sketch-plane-session-lock.md) | Active Sketch Plane Session Lock — 사용자 작업지시 trigger | Proposed | Track 5 |
| 167 (reserve) | EPS_PLANE SSOT + same_plane() helper — ADR-166 자연 후속 | Reserved | Track 5 |
| 168 (reserve) | Face plane drift snap — ADR-167 자연 후속 | Reserved | Track 5 |
