...
export class WasmBridge {
  ...
  injectExternalFacePlane(
    ...
    // ADR-102 R-δ — `unknown` bridge cast: wasm-bindgen's signature uses
    // `(...args: number[]) => number` but the actual call takes a
    // Float64Array as first arg. Cast via `unknown` per TS strict TS2352.
