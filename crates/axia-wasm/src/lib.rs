...
impl AxiaEngine {
    ...
    pub fn draw_line(
        ...
        match result {
            axia_core::commands::CommandResult::EntityCreated(id) => id as f64,
            _ => -1.0,
        }
    }
    ...
    pub fn draw_rect(
        ...
        self.invalidate_cache();
        match result {
            axia_core::commands::CommandResult::EntityCreated(id) => {
                // Log face normal for debugging
                let face_count = self.scene.mesh.face_count();
                console_log!("[RUST] draw_rect: xia={} faces={} input_normal=({},{},{})",
                    id, face_count, nx, ny, nz);
                id as f64
            },
            _ => -1.0,
        }
